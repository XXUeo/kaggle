...
# first parameter taking all value in train_data except 0 column
#second parameter taking all survivor column. 
print 'Predicting...'
output = forest.predict(test_data).astype(int)
#so except survivor column, it has to match with train_data.
